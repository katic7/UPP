...
@Service
public class OdbijanjeRada implements JavaDelegate {
	...
	private void sendEmailAutoru(Korisnik k, String rad) throws MessagingException, UnsupportedEncodingException {
        ...
        htmlMsg += "<h3> Vas zahtev za kreiranje rada: \"" +rad +"\" je nazolst odbijen nakon pregleda glavnog recezenta</h3>";
        ...
        helper.setSubject("Naučna centrala - zahtev odbijen");
