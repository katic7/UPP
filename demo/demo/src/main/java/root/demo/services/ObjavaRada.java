...
public class ObjavaRada implements JavaDelegate {
	...
	private void sendEmailAutoru(Korisnik k, String rad) throws MessagingException, UnsupportedEncodingException {
        ...
        htmlMsg += "<h3> Vas zahtev za kreiranje rada: \"" +rad +"\" je prihvacen i Vas rad ce viti objavljen u najkracem roku.</h3>";
        ...
        helper.setSubject("Naučna centrala - zahtev prihvacen");
